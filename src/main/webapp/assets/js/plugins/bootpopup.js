...
function bootpopup(options) {
    ...
    var modalWindow = $('<div class="modal bootpopup fade" tabindex="-1" role="dialog" aria-labelledby="bootpopup-title"></div>');
    ...
    for(key in opts.buttons) {
        ...
        switch(item) {
            ...
            case "close": btnClass = "btn-default-theme"; btnText="Close"; break;
            case "ok": btnClass = "btn-default-theme"; btnText="OK"; break;
            case "cancel": btnClass = "btn-default-theme"; btnText="Cancel"; break;
            case "yes": btnClass = "btn-default-theme"; btnText="Yes"; break;
            case "no": btnClass = "btn-default-theme"; btnText="No"; break;
        }
        
        $("<button></button>", {
            type: "button",
            text: btnText,
            class: "btn btn-info btn-default-theme " + btnClass,
            "data-dismiss": "modal",
            "data-callback": item,
