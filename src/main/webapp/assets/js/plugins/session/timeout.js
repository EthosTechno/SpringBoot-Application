            ...
            if (!keepAlivePinged) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                    	if(data.status == "403") {
                    		window.location.href = opt.logoutUrl;
                    	}
                    },
                    error: function (request, status, error) {
                    	if(status != 200) {
	                    	$("#connection-timeout-dialog").modal("hide");
	                    	$("#connection-timeout-dialog").remove();
	                    	// Create timeout warning dialog
	                        $('body').append('<div class="modal" id="connection-timeout-dialog"> \
	                          <div class="modal-dialog"> \
	                            <div class="modal-content"> \
	                              ...
	                              <div class="modal-body"> \
	                                <center style="color: var(--copy);"> \
	            						<h1><i class="glyphicon glyphicon-thumbs-down"></i></h1> \
